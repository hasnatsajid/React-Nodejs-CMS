      ...
      {showSettings ? (
        <Card className="theme-settings">
          <Card.Body className="pt-4">
            ...
            <Button href="https://hassuu.com/product/dashboard/volt-react" target="_blank" variant="primary" className="mb-3 w-100">
            ...
            <div className="d-flex justify-content-center">
              <Card.Link href="https://hassuu.com/product/admin-dashboard/volt-bootstrap-5-dashboard" target="_blank">
                <OverlayTrigger
                  placement="top"
                  trigger={['hover', 'focus']}
                  overlay={<Tooltip>Bootstrap 5 · The most popular HTML, CSS, and JS library in the world.</Tooltip>}
                >
                  <Image src={BS5Logo} className="image image-xs" />
                </OverlayTrigger>
              </Card.Link>

              <Card.Link href="https://hassuu.com/product/dashboard/volt-react" target="_blank">
                <OverlayTrigger
                  placement="top"
                  trigger={['hover', 'focus']}
                  overlay={<Tooltip>React · A JavaScript library for building user interfaces.</Tooltip>}
                >
                  <Image src={ReactLogo} className="image image-xs" />
                </OverlayTrigger>
              </Card.Link>

              <Card.Link href="https://hassuu.com/product/laravel/volt-admin-dashboard-template" target="_blank">
        ...
        <Row>
          <Col xs={12} lg={6} className="mb-4 mb-lg-0">
            <p className="mb-0 text-center text-xl-left">
              ...
              <Card.Link href="https://hassuu.com" target="_blank" className="text-blue text-decoration-none fw-normal">
                Hassuu
              </Card.Link>
            </p>
          </Col>
          <Col xs={12} lg={6}>
            <ul className="list-inline list-group-flush list-group-borderless text-center text-xl-right mb-0">
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://hassuu.com/about" target="_blank">
                  About
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://hassuu.com/themes" target="_blank">
                  Themes
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://hassuu.com/blog" target="_blank">
                  Blog
                </Card.Link>
              </li>
              <li className="list-inline-item px-0 px-sm-2">
                <Card.Link href="https://hassuu.com/contact" target="_blank">
                  Contact
                </Card.Link>
              </li>
            </ul>
